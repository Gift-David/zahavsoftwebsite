                ...
                <div className="flex justify-between md:items-center">
                    ...
                    <div className="flex gap-2">
                        <button className="cursor-pointer" disabled={currentIndex === 0}>
                            <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg" className={`w-10 h-10 md:w-13.5 md:h-13.5`} onClick={prev}>
                                <g opacity="0.5">
                        ...
                        <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 md:w-13.5 md:h-13.5" onClick={next}>
