    ...
    return (
      <>
        <section className="flex flex-col hero-bg ">
            <Navbar />
            <div className=" relative flex flex-col-reverse lg:flex-row gap-14.75 justify-center items-center pt-25 pr-4 pl-4 md:pr-8 md:pl-8 pb-10 lg:pr-20 lg:pl-20 lg:pb-10">
